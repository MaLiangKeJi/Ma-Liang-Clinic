    ...
    <div style="height: 100vh; padding: 2%;">
        <el-form ref="formRef" :model="form" style="height: 10%; display: flex; justify-content: space-between;">
            <div style="width: 10%; height: 100%; padding-left: 20px; text-align: center; display: flex; align-items: center;">
                <el-text class="mx-1" style="font-size: 1.5vw; font-weight: 700;">器械采购</el-text>
            </div>
            <div style="width: 90%; height: 100%; display: flex; align-items: center; justify-content: flex-end;">
                ...
                <el-form-item style="width: 20%;">
                    <el-button class="search_button" @click="handle.resetClick" style="width: 200px;"  type="primary" plain>
                        重置
                    </el-button>
                </el-form-item>
            </div>
        ...
        <el-card style="height: 85%; border-radius: 15px;">
            ...
            >
                ...
                <el-table-column align="center" prop="name" label="姓名">
                    <template #default="{ row }">
                        <span style="font-weight: 700;">{{ convertName(row.name) }}</span>
                   </template>
                </el-table-column>
                ...
                <el-table-column align="center" prop="isFirst" label="初复诊" :formatter="convertIsFirst">
                    <template #default="{ row }">
                        <el-tag 
                            :type="row.isFirst == 0 ? 'success' : 'info'" 
                            effect="light" 
                            style="width: 100px; height: 30px; font-weight: 700; font-size: 1.5vh;"
                        >
                            {{row.isFirst == 0 ? '初诊' : '复诊'}}
                        </el-tag>
                    </template>
                ...
                <el-table-column align="center" prop="diagnosis" label="诊断" :formatter="convertDiagnosis">
                    <template #default="{ row }">
                        <span style="font-weight: 700;">{{ row.diagnosis }}</span>
                   </template>
                </el-table-column>
