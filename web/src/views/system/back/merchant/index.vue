    ...
    <div style="height: 100vh; padding: 2%;">
        <el-form ref="formRef" :model="form" style="height: 10%; display: flex; justify-content: space-between;">
            <div style="width: 30%; height: 100%; padding-left: 20px; text-align: center; display: flex; align-items: center;">
                <el-text class="mx-1" style="font-size: 1.5vw; font-weight: 700;">商家后台</el-text>
            </div>
            <div style="width: 90%; height: 100%; display: flex; align-items: center; justify-content: flex-end;">
                <el-form-item style="width: 10%;">
                    <el-text class="mx-1" style="width: 100%; height: 100%; text-align: right; font-size: 1vw; padding-right: 10%;">药品搜索</el-text>
                </el-form-item>
                <el-form-item style="width: 20%;">
                    <el-input style="width: 100%;" class="search_input" v-model="form.val" placeholder="药品名 / 国字准号 / 商品码 / 厂商名 " 
                ...
                <el-form-item style="width: 20%;">
                    <el-button class="search_button" @click="handle.shelfClick" style="width: 10vw; border-radius: 5px; height: 6vh !important;"  type="primary" plain>
                        上架药品
                    </el-button>
                </el-form-item>
            </div>
        ...
        <el-card v-if="currentModel == model.myInvite" style="height: 65%; border-radius: 15px;">
            <el-table 
                ...
                scrollbar-always-on
            >
                <el-table-column align="center" prop="createTimeStr" label="上架日期">
                    <template #default="{ row }">
                        <span style="font-weight: 700;">{{ row.createTimeStr }}</span>
                   </template>
                </el-table-column>
                <el-table-column align="center" prop="name" label="药品名">
                    <template #default="{ row }">
                        <span style="font-weight: 700;">{{ convertName(row.invitedUser.name) }}</span>
                   </template>
                </el-table-column>
                <el-table-column align="center" prop="phone" label="展示标题">
                    <template #default="{ row }">
                        <span style="font-weight: 700;">{{ row.invitedUser.phone }}</span>
                   </template>
                </el-table-column>
                <el-table-column align="center" prop="phone" label="上架状态">
                    <template #default="{ row }">
                        <span style="font-weight: 700;">{{ row.invitedUser.phone }}</span>
                   </template>
                </el-table-column>
...
const handle = {
    ...
    shelfClick() {
        routerInstance.push({ path: '/clinic/back/merchant/shelf' })
    },
}
